        ...
        <div class="col-md-8 offset-md-2">
            <form:form class="custom-form" method="post" action="guardaAseso">
                ...
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="detalle-input-field">Nombre Asesoria: </label></div>
                    <div class="col-sm-6 input-column"><form:input path="nombreAseso" class="form-control" type="text" /></div>
                </div>
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="estado-input-field">Detalle Asesoria: </label></div>
                    <div class="col-sm-6 input-column"><form:input path="detalleAseso" class="form-control" type="text" /></div>
                </div>
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="fecha-input-field">Fecha Asesoria: </label></div>
                    <div class="col-sm-6 input-column"><form:input path="fechaAseso" class="form-control" type="text" /></div>
                </div>
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="nombre-input-field">Rut Cliente: </label></div>
