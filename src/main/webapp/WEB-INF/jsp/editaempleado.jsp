...
<div class="row register-form">
        <div class="col-md-8 offset-md-2">
            <form:form class="custom-form" method="post" action="/modulo5dia12/cambiospro">
                ...
                <div class="form-row form-group">
                    ...
                    <div class="col-sm-6 input-column"><form:input path="rutEmp" class="form-control" type="number" length="8" readonly="true" /></div>
                </div>
                <div class="form-row form-group">
